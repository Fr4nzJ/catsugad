...
<head>
    ...
    <title>Create Banner - GAD CatSU Admin</title>
            ...
            <div class="column is-9">
                <div class="content-box">
                    <div class="page-header">
                        <h2><i class="fas fa-plus"></i> Create New Banner</h2>
                    ...
                    <form method="POST" action="{{ route('admin.banners.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <input class="input @error('name') is-danger @enderror" type="text" name="name" placeholder="e.g., Main Home Banner" value="{{ old('name') }}" required>
                            </div>
                            @error('name')
                            ...
                            <div class="control">
                                <label class="file-upload-label" for="imageInput" id="uploadLabel">
                                    <span>
                                        ...
                                        <small style="color: #999;">PNG, JPG, GIF, WebP up to 20MB</small>
                                    </span>
                                </label>
                                <input type="file" id="imageInput" name="image" accept="image/*" @error('image') is-danger @enderror>
                                <div class="image-preview-container" id="previewContainer">
                                    <p style="color: #666; margin-bottom: 0.5rem; font-weight: 600;">Preview:</p>
                            ...
                            <div class="control">
                                <div class="select is-fullwidth @error('page') is-danger @enderror">
                                    <select name="page" required>
                                        ...
                                        <option value="events" {{ old('page') === 'events' ? 'selected' : '' }}>Events</option>
                                        <option value="reports" {{ old('page') === 'reports' ? 'selected' : '' }}>Reports</option>
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <textarea class="textarea @error('description') is-danger @enderror" name="description" placeholder="Enter banner description..." rows="4">{{ old('description') }}</textarea>
                            </div>
                            @error('description')
                                <p class="error-text">{{ $message }}</p>
                            @enderror
