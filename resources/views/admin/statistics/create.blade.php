...
<head>
    ...
    <title>Create Statistic - GAD CatSU Admin</title>
            ...
            <div class="column is-9">
                <div class="content-box">
                    <div class="page-header">
                        <h2><i class="fas fa-plus"></i> Create New Statistic</h2>
                    ...
                    <form method="POST" action="{{ route('admin.statistics.store') }}">
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <input class="input @error('value') is-danger @enderror" type="text" name="value" placeholder="e.g., 500+" value="{{ old('value') }}" required>
                            </div>
                            @error('value')
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <input class="input @error('label') is-danger @enderror" type="text" name="label" placeholder="e.g., Beneficiaries Reached" value="{{ old('label') }}" required>
                            </div>
                            @error('label')
                                <p class="error-text">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <textarea class="textarea @error('description') is-danger @enderror" name="description" placeholder="Enter description..." rows="4">{{ old('description') }}</textarea>
                            </div>
                            @error('description')
                                <p class="error-text">{{ $message }}</p>
                            @enderror
                            ...
                            <div class="control">
                                <div class="select is-fullwidth @error('icon') is-danger @enderror">
                                    <select name="icon">
                                        ...
                                        <option value="fas fa-users" {{ old('icon') === 'fas fa-users' ? 'selected' : '' }}>👥 Users</option>
                                        <option value="fas fa-chart-bar" {{ old('icon') === 'fas fa-chart-bar' ? 'selected' : '' }}>📊 Chart Bar</option>
                                        ...
                                        <option value="fas fa-user" {{ old('icon') === 'fas fa-user' ? 'selected' : '' }}>👤 User</option>
                                        ...
                                        <option value="fas fa-calendar" {{ old('icon') === 'fas fa-calendar' ? 'selected' : '' }}>📅 Calendar</option>
                                        <option value="fas fa-bullseye" {{ old('icon') === 'fas fa-bullseye' ? 'selected' : '' }}>🎯 Bullseye</option>
                                    </select>
                                </div>
                            </div>
                            @error('icon')
