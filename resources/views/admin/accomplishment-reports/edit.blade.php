...
<head>
    ...
    <title>Edit Accomplishment Report - GAD CatSU Admin</title>
                                    ...
                                    <div class="control">
                                        <div class="select is-fullwidth @error('college') is-danger @enderror">
                                            <select name="college" required>
                                                ...
                                                <option value="College of Computer Studies" {{ old('college', $accomplishmentReport->college) === 'College of Computer Studies' ? 'selected' : '' }}>College of Computer Studies</option>
                                                <option value="College of Business Administration" {{ old('college', $accomplishmentReport->college) === 'College of Business Administration' ? 'selected' : '' }}>College of Business Administration</option>
                                                <option value="College of Engineering" {{ old('college', $accomplishmentReport->college) === 'College of Engineering' ? 'selected' : '' }}>College of Engineering</option>
                                                <option value="College of Arts and Sciences" {{ old('college', $accomplishmentReport->college) === 'College of Arts and Sciences' ? 'selected' : '' }}>College of Arts and Sciences</option>
                                                <option value="College of Education" {{ old('college', $accomplishmentReport->college) === 'College of Education' ? 'selected' : '' }}>College of Education</option>
                                            </select>
                                        </div>
                                    </div>
                                    @error('college')
